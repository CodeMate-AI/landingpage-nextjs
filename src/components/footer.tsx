...
function ChatGPTIcon() {
  return (
    <svg className="w-5 h-5 text-black group-hover:scale-105 transition-transform" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
function ClaudeIcon() {
  return (
    <svg className="w-5 h-5 group-hover:scale-105 transition-transform" viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
function GrokIcon() {
  return (
    <svg className="w-5 h-5 text-white group-hover:scale-105 transition-transform" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
