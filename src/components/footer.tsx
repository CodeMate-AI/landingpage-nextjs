...
function Footer() {
  return (
    <motion.footer className="relative text-gray-200 pb-0 pt-16 overflow-hide bg-[#121214] border-t-[1px] border-zinc-500 rounded-t-[3rem] z-[999999] lg:z-[9999999999]">
      <motion.div className="w-full px-10 mx-auto flex flex-col md:flex-row md:justify-center gap-10 md:gap-12 pb-10">
        ...
        <div className="flex-1 min-w-[220px] ml-0 md:ml-8">
          ...
          <div className="flex gap-3 mt-2">
            ...
            <a href="https://www.instagram.com/codemateai" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-white">
              <FaInstagram size={32} className="md:w-10 md:h-10" />
            </a>
            <a href="https://www.youtube.com/@codemateai" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:text-white">
              <FaYoutube size={32} className="md:w-10 md:h-10" />
            </a>
          </div>

          <div className="mt-8">
            <h4 className="font-semibold text-gray-300 text-xs md:text-sm uppercase tracking-wider mb-3">
