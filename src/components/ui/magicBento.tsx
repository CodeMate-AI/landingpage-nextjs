...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 p-3 max-w-full h-screen  pt-20 select-none relative px-16"
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
    <>
      ...
      <div className="h-[100vw] w-[100vw] z-50">
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2 pt-20 z-50">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between  relative aspect-[4/3] min-h-[200px] max-w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
