...
const DownloadPage = () => {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans flex flex-col justify-between pt-28 relative">
            <div className="flex flex-col items-center px-4 pb-20 w-full">
                {/* Global Navbar */}
