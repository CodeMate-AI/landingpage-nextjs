        ...
        <div className="relative z-20 w-full flex flex-col lg:flex-row items-start">
          ...
          <div className="flex flex-col items-center w-full lg:w-[32vw] lg:mr-6 lg:py-8 lg:gap-2 pb-8">
            ...
            {[
              ...
              { href: "https://app.codemate.ai/chat", img: "/Co web Static.png", imgClass: "w-full h-auto object-contain rounded-t-lg shadow-[0_-10px_40px_rgba(0,0,0,0.5)]", bottom: "bottom-[0.4rem] lg:bottom-[2.5rem]", px: true, title: "CodeMate Work", desc: "Turns deep research, connectors, storage, and rules into production ready code." },
