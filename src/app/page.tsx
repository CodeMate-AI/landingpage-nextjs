      ...
      <div className='h-auto lg:h-screen lg:max-h-[860px] lg:min-h-[640px] w-full overflow-x-hidden relative'>
        ...
        >
          <div
            ...
            className='relative h-auto lg:h-screen lg:max-h-[860px] lg:min-h-[640px] w-full z-50 overflow-hidden cursor-default flex flex-col justify-start pt-12 sm:pt-16 lg:pt-[8vh] pb-8 lg:pb-16'
          >
            <motion.div
            ...
            <div className='relative z-50 w-full px-6 sm:px-8 lg:px-0 lg:pl-[calc(3.3vw+3rem)] lg:pr-12 flex flex-col items-start'>
              <h1 className='text-[clamp(2.5rem,11vw,4.5rem)] lg:text-[clamp(5rem,8vw,8rem)] leading-[1.05] font-semibold flex flex-col z-50 xxlHerotext text-left mt-1 sm:mt-4 lg:mt-6'>
