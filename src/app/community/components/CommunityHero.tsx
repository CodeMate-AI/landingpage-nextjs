...
export default function CommunityHero() {
  return (
    <section className="relative mx-auto flex max-w-5xl flex-col items-start justify-center px-5 pb-12 pt-8 text-left sm:items-center sm:px-6 sm:pb-16 sm:pt-12 sm:text-center lg:px-8 lg:pt-16">
      <div
