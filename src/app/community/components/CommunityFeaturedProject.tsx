  ...
  return (
    <section className="flex justify-center px-4 pb-16 pt-6 sm:px-6 sm:pb-24 sm:pt-8 lg:px-8">
      <motion.div
        ...
        className="flex w-full max-w-7xl flex-col gap-8 rounded-3xl border border-white/10 bg-zinc-900/60 p-6 shadow-2xl backdrop-blur-xl lg:flex-row lg:gap-10 lg:p-10"
      >
        <div className="flex w-full flex-col gap-5 lg:w-[58%]">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-2.5 text-sm font-bold text-black shadow-lg transition-shadow hover:bg-zinc-100"
            >
              Visit Live App
