...
/**
 * CommunityPage composes the full /community route with native scrolling and the
 * same custom cursor treatment used on the landing page.
 */
...
export default function CommunityPage() {
  ...
  return (
    <div
      ...
      className={`${montserrat.className} min-h-screen overflow-x-hidden bg-zinc-950 pt-[92px] text-white sm:pt-[104px] lg:pt-[110px]`}
    >
      <Navbar />
